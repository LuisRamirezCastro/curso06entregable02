...
Las pruebas se ejecutarán contra https://www.google.com, componentes Requeridos:
...
2. Crear una carpeta que se llame: /load_test/
3. Agregar el script del proyecto dentro de la carpeta.
